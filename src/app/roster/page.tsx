...
export default function RosterPage() {
  return (
    <section className="mx-auto max-w-7xl px-4 py-20">
      <h1 className="mb-12 font-heading text-5xl uppercase text-white md:text-6xl"><span className="text-brand-red">Roster</span></h1>
      ...
      <AnimatedSection>
        <div className="mt-20">
          <h2 className="mb-8 font-heading text-3xl uppercase text-white/30">Coaching Staff</h2>
