...
export default function SponsorsPage() {
  ...
  return (
    <section className="mx-auto max-w-5xl px-4 py-20">
      <h1 className="mb-12 font-heading text-5xl uppercase text-white md:text-6xl">{t.sponsors.title} <span className="text-brand-red">{t.sponsors.titleAccent}</span></h1>
      ...
      <AnimatedSection delay={0.2}>
        <div className="mt-20 rounded-lg border border-white/10 bg-white/5 p-8 text-center">
          <h2 className="font-heading text-2xl text-white">{t.sponsors.becomeSponsor}</h2>
