      ...
      <AnimatedSection>
        <div className="space-y-5 text-white/75 leading-relaxed">
          ...
          <p>
            ...
            кошаркарски клуб од{" "}
            <strong className="text-white">Велес</strong>, Северна Македонија,
      ...
      <AnimatedSection>
        <div className="space-y-6 text-white/75 leading-relaxed mt-16">
          ...
          <div className="relative pl-5 border-l-2 border-brand-red/40">
            ...
            <p>
              Амбициите растеа. Клубот заврши со ист број поени со вториот
              тим, но меѓусебната среќа одлучи — Борец Баскет паѓа на 4-то
              место. Уска граница, горчлива поука.
            </p>
          </div>
          ...
          <div className="relative pl-5 border-l-2 border-white/15">
            ...
            <p>
              Кошарката понекогаш бара повеќе отколку победи на паркет.
              Клубот освои право на промоција, но поради непостоење соодветна
              сала за играње на повисоко ниво, беше принуден да ја одбие.
              Инфраструктурата остана предизвик.
            </p>
          </div>
          ...
          <div className="relative pl-5 border-l-2 border-white/15">
            ...
            <p>
              Во оваа сезона клубот настапуваше под привремено изменето
              спонзорско име <em>Борец Еуробрик</em>. Сезоната не беше
              завршена — клубот се повлече среде натпреварувањето.
            </p>
          </div>
          ...
          <div className="relative pl-5 border-l-2 border-brand-red/40">
            <span className="absolute -left-[11px] top-1 w-5 h-5 rounded-full bg-brand-red border-2 border-black" />
            <h3 className="font-heading text-xl text-white mb-1">
              2019/20 — Брчков и КОВИД прекин
            </h3>
            <p>
              Сезоната 2019/20 донесе ново засилување: потпиша поранешниот
              репрезентативец{" "}
              <strong className="text-white">Владимир Брчков</strong>, чие
              искуство и квалитет ги подигна очекувањата на целиот клуб.
              Борец Баскет беше во трка за 4-то место кога пандемијата
