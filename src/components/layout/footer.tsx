    ...
    <footer className="border-t border-white/10 bg-brand-black">
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider text-white/30">Links</h3>
          ...
          <div>
            <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider text-white/30">Follow Us</h3>
